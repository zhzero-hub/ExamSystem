...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <table class="edtitable">
            <thead>
            <tr>
                <th colspan="4" style="text-align:center">程序设计题</th>
            </tr>
            </thead>
            <tbody>
            <tr>
            ...
            <c:forEach items="${readPrograml}" var="pd">
                <tr>
                    <c:set var="index" value="${index+1}"/>
                    <td>${index}</td>
                    <td class="line">${pd.content}</td>
                    <td>${pd.difficulty}</td>
                    <td class="del-col">
                        <a href="#" onclick="return edit(${pd.id})" style="text-decoration: none;">
                            <span class="fa fa-edit fa-fw"></span>
                        </a>
                        <a href="#" onclick="return trash(${pd.id})" style="text-decoration: none;"
        ...
        <!--添加-->
        <div class="modal fade" id="addpd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
