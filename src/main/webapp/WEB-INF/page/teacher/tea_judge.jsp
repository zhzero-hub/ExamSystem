...
<script type="text/javascript">
    $(function(){
        ...
        $('#getAllSelectedId').click(function(){
            ...
            location.href = "<%=basePath%>/tea_tk/deletemanyjudge.do?chk_value="+chk_value;
        ...
        <div class="modal fade" id="editch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/tea_tk/upjudge.do" method="post">
        ...
        <div class="modal fade" id="addch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/tea_tk/createjudge.do" method="post">
                        <div class="modal-body">
                            <%--<input name="id" id="id" hidden="hidden"/>--%>
                            <div class="form-group input-group">
                                <span class="input-group-addon" style="height: 40px ; tab-size: 16px ">题目：</span>
...
<script>
    ...
    function edit(id) {
        // 先去查询数据
        $.ajax({
            url: '<%=basePath%>/tea_tk/judgeId.do',
            type: 'POST',
            dataType: 'json',
    ...
    function trash(id) {
        if (!id) {
            ...
            $(".delSure").click(function () {
                $.ajax({
                    url: '<%=basePath%>/tea_tk/deletejudge.do?id=' + id,
                    type: 'POST',
                    success: function (data) {
                        $("body").html(data);
                    }
