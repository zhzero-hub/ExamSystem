        ...
        <tr class="append-row">
            <td colspan="5" align="right">
                ...
                <div class="modal fade" id="myModa_n" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="<%=basePath%>/basic/adddepart.do" method="post">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body" style="text-align:left">
                                    <div class="form-group input-group">
                                        ...
                                        <input type="text" style="height: 40px " class="form-control" name="depart">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button"  class="btn btn-outline btn-primary" data-dismiss="modal">关闭</button>
...
<script>
    ...
    function deletemajor(id) {
        ...
        $(".delSure").click(function () {
                    $.ajax({
                        url: '<%=basePath%>/basic/deletedepart.do?id='+ id,
                        type: 'POST',
