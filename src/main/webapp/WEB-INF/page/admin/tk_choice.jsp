...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<%=basePath%>/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="<%=basePath%>/user/findallchoice.do?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="<%=basePath%>/user/findallchoice.do?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="<%=basePath%>/user/findallchoice.do?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="<%=basePath%>/user/findallchoice.do?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/user/updatech.do" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="upaddbut" onclick="alert('信息提交成功！')">提交</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/user/addchoice.do" method="post">
                        <div class="modal-body">
                            <input name="id" id="choiceid" hidden="hidden"/>
                            <div class="form-group input-group">
                                <span class="input-group-addon" style="height: 40px ; tab-size: 16px ">题目：</span>
